...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub fn cc_dith6_mode(&self) -> &[CC_DITH6_MODE; 4] {
        unsafe {
            &*(((self as *const Self) as *const u8).add(68usize) as *const [CC_DITH6_MODE; 4])
        }
    }
    #[doc = "0x44 - Compare and Capture"]
    #[inline(always)]
    pub fn cc_dith6_mode_mut(&self) -> &mut [CC_DITH6_MODE; 4] {
        unsafe {
            &mut *(((self as *const Self) as *mut u8).add(68usize) as *mut [CC_DITH6_MODE; 4])
        }
    }
    #[doc = "0x44 - Compare and Capture"]
    #[inline(always)]
    pub fn cc_dith5_mode(&self) -> &[CC_DITH5_MODE; 4] {
        unsafe {
            &*(((self as *const Self) as *const u8).add(68usize) as *const [CC_DITH5_MODE; 4])
        }
    }
    #[doc = "0x44 - Compare and Capture"]
    #[inline(always)]
    pub fn cc_dith5_mode_mut(&self) -> &mut [CC_DITH5_MODE; 4] {
        unsafe {
            &mut *(((self as *const Self) as *mut u8).add(68usize) as *mut [CC_DITH5_MODE; 4])
        }
    }
    #[doc = "0x44 - Compare and Capture"]
    #[inline(always)]
    pub fn cc_dith4_mode(&self) -> &[CC_DITH4_MODE; 4] {
        unsafe {
            &*(((self as *const Self) as *const u8).add(68usize) as *const [CC_DITH4_MODE; 4])
        }
    }
    #[doc = "0x44 - Compare and Capture"]
    #[inline(always)]
    pub fn cc_dith4_mode_mut(&self) -> &mut [CC_DITH4_MODE; 4] {
        unsafe {
            &mut *(((self as *const Self) as *mut u8).add(68usize) as *mut [CC_DITH4_MODE; 4])
        }
    }
    #[doc = "0x44 - Compare and Capture"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn ccbuf_dith6_mode(&self) -> &[CCBUF_DITH6_MODE; 4] {
        unsafe {
            &*(((self as *const Self) as *const u8).add(112usize) as *const [CCBUF_DITH6_MODE; 4])
        }
    }
    #[doc = "0x70 - Compare and Capture Buffer"]
    #[inline(always)]
    pub fn ccbuf_dith6_mode_mut(&self) -> &mut [CCBUF_DITH6_MODE; 4] {
        unsafe {
            &mut *(((self as *const Self) as *mut u8).add(112usize) as *mut [CCBUF_DITH6_MODE; 4])
        }
    }
    #[doc = "0x70 - Compare and Capture Buffer"]
    #[inline(always)]
    pub fn ccbuf_dith5_mode(&self) -> &[CCBUF_DITH5_MODE; 4] {
        unsafe {
            &*(((self as *const Self) as *const u8).add(112usize) as *const [CCBUF_DITH5_MODE; 4])
        }
    }
    #[doc = "0x70 - Compare and Capture Buffer"]
    #[inline(always)]
    pub fn ccbuf_dith5_mode_mut(&self) -> &mut [CCBUF_DITH5_MODE; 4] {
        unsafe {
            &mut *(((self as *const Self) as *mut u8).add(112usize) as *mut [CCBUF_DITH5_MODE; 4])
        }
    }
    #[doc = "0x70 - Compare and Capture Buffer"]
    #[inline(always)]
    pub fn ccbuf_dith4_mode(&self) -> &[CCBUF_DITH4_MODE; 4] {
        unsafe {
            &*(((self as *const Self) as *const u8).add(112usize) as *const [CCBUF_DITH4_MODE; 4])
        }
    }
    #[doc = "0x70 - Compare and Capture Buffer"]
    #[inline(always)]
    pub fn ccbuf_dith4_mode_mut(&self) -> &mut [CCBUF_DITH4_MODE; 4] {
        unsafe {
            &mut *(((self as *const Self) as *mut u8).add(112usize) as *mut [CCBUF_DITH4_MODE; 4])
        }
    }
    #[doc = "0x70 - Compare and Capture Buffer"]
    #[inline(always)]
    pub fn ccbuf(&self) -> &[CCBUF; 4] {
        unsafe { &*(((self as *const Self) as *const u8).add(112usize) as *const [CCBUF; 4]) }
    }
    #[doc = "0x70 - Compare and Capture Buffer"]
    #[inline(always)]
    pub fn ccbuf_mut(&self) -> &mut [CCBUF; 4] {
        unsafe { &mut *(((self as *const Self) as *mut u8).add(112usize) as *mut [CCBUF; 4]) }
    }
}
