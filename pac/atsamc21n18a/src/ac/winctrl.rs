...
#[doc = "Reader of field `WEN1`"]
pub type WEN1_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `WEN1`"]
pub struct WEN1_W<'a> {
    w: &'a mut W,
}
impl<'a> WEN1_W<'a> {
...
#[doc = "Reader of field `WINTSEL1`"]
pub type WINTSEL1_R = crate::R<u8, WINTSEL1_A>;
impl WINTSEL1_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `WINTSEL1`"]
