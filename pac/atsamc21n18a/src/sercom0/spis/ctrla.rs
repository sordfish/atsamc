...
pub enum DOPO_A {
    ...
    PAD0 = 0,
    #[doc = "1: DO on PAD\\[2\\], SCK on PAD\\[3\\] and SS on PAD\\[1\\]"]
    PAD1 = 1,
    #[doc = "2: DO on PAD\\[3\\], SCK on PAD\\[1\\] and SS on PAD\\[2\\]"]
    PAD2 = 2,
    #[doc = "3: DO on PAD\\[0\\], SCK on PAD\\[3\\] and SS on PAD\\[1\\]"]
    PAD3 = 3,
}
...
impl<'a> DOPO_W<'a> {
    ...
    #[doc = "DO on PAD\\[2\\], SCK on PAD\\[3\\] and SS on PAD\\[1\\]"]
    #[inline(always)]
    ...
    #[doc = "DO on PAD\\[0\\], SCK on PAD\\[3\\] and SS on PAD\\[1\\]"]
    #[inline(always)]
